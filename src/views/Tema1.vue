...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      SlyderA(tipo="b")
        ...
        .row
          .col-md-8.mb-4.mb-md-0
            ...
            p Ahora que el mundo acaba de vivir una pandemia y la humanidad vive un momento muy difícil, es necesario considerar con más detalle este aspecto, no solo porque hay regiones y culturas en donde no es importante este hecho y porque no se puede poner en riesgo la salud de los asistentes; entonces se debe estudiar, entre otros aspectos, las  condiciones de salud pública existentes en la ciudad, el porcentaje de la población y número de vacunados de la pandemia (COVID) en el país y la ciudad, la vacunación infantil, esquemas y programas de medicina preventiva, capacidad e instrucción sobre prevención y actuación en casos de desastres, factores epidemiológicos o endémicos regionales y conocimientos de la manipulación de alimentos de la ciudad.
    ...
    .cajon.bgr-tarjeta-1.p-4.mt-5
      .row
        .col-12
          p Al observarse cómo hay variables que pueden afectar el libre desarrollo del evento, las cuales hay que considerar y tratar de controlar, ahora, el enfoque es identificar, analizar y controlar, aquellos imprevistos que pueden ocurrir al interior y que si se pueden controlar, ya que con anterioridad se han identificado para crear los enlaces de apoyo con soluciones inmediatas y efectivas que permitan continuar con el evento, sin afectar el desarrollo de este. El enfoque ahora es definir y analizar cada una de las actividades a desarrollar y seleccionarlas por grupos. 
    ...
    p.mt-5 Entonces, se deben considerar  todas las variables anteriores para tener un plan alterno que ayude a tomar las decisiones más acertadas.
    ...
    p En cuanto a permisos y reglamentaciones, deben entonces considerarse: 
    ...
    .titulo-segundo.color-acento-contenido.mt-5
      h2 1.3 Alimentos y bebidas   

    .row.justify-content-around.align-items-center.mt-5.mb-5
      .col-lg-8
        p En muchos eventos, el servicio de alimentos y bebidas es fundamental, este puede darse de diferentes formas, como refrigerio, onces, tipo lunch, almuerzos, cenas, desayunos de trabajo, pasabocas y cocteles, entre otros, los cuales estudiará en otro componente formativo.  Muchas veces este aspecto se convierte en uno de los referentes de éxito o fracaso de la actividad.

        p Una adecuada planeación en cuanto a este servicio se refiere, ayudará a evitar inconvenientes de último minuto. Al pensar en el menú que se va a ofrecer se debe tener en cuenta los siguientes aspectos:
    ...
    ImagenInfografica.color-primario
      ...
      .tarjeta.color-primario.p-3(x="40%" y="12%" numero="1")
        p Show, artistas, DJ, música ambiental, música en vivo.
      ...
      .tarjeta.color-primario.p-3(x="76%" y="35%" numero="4")
        p Requerimientos técnicos: proyecciones, grabaciones, video, audio, fotografía, videoconferencias, live streaming.
      ...
      .tarjeta.color-primario.p-3(x="17%" y="90%" numero="8")
        p Equipo de trabajo personal de apoyo, logística, inscripciones (software, hardware), aseo, alimentos y bebidas, seguridad, etc.
